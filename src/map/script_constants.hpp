...
/// @APIHOOK_START(EFST_CONST)
	...
	export_constant(EFST_SHARINGAN);
	export_constant(EFST_SHARINGAN2);
	export_constant(EFST_SHARINGAN3);
	export_constant(EFST_SHARINGANMK);
	export_constant(EFST_SHARINGANMO);
	export_constant(EFST_SHARINGANMS);
	export_constant(EFST_SHARINGANMI);
	export_constant(EFST_SHARINGANMM);
	export_constant(EFST_SUSANOS1);
	export_constant(EFST_SUSANOS2);
	export_constant(EFST_SUSANOS3);
	export_constant(EFST_SUSANOS4);
	export_constant(EFST_HENGE);
	export_constant(EFST_CLOAKKYU1);
	export_constant(EFST_CLOAKKYU4);
	export_constant(EFST_BYAKUGAN1);
	export_constant(EFST_BYAKUGAN2);
	export_constant(EFST_BYAKUGAN3);
	export_constant(EFST_BYAKUGAN4);
/// @APIHOOK_END
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant(HAT_EF_BYAKUGANEF);
